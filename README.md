# XinzheSecurity
一个安卓手机管家APP</br>
本应用能管理您的安卓智能手机，它具备了市面上其他竞品常见的功能。如：</br>
- 手机杀毒
- 应用管理
- 拦截骚扰
- 手机防盗
...
- 流量统计
- 清理优化</br>
虽然功能不像商业软件般强大，但也基本的实现并能使用。
应用简图见(https://github.com/linxinzhe/XinzheSecurity/blob/master/App%20Preview.png)</br>
另外，本应用也经过第三方自动化测试，具有良好的性能和可靠性(https://github.com/linxinzhe/XinzheSecurity/blob/master/Automated%20Testing%20Result.png)</br>
</br>
